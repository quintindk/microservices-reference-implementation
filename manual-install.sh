...
export RESOURCE_GROUP=rgdemodronedeliveries
...
echo Deployed the Identities

echo Deploying the ARM templates
...
echo Deployed the ARM templates
...
echo Deploying gateway ingress controller
...
echo Deploy the Delivery service
...
echo Deploy the Package service
...
echo Deploy the Workflow service
